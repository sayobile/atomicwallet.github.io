$(function(){
	var items,
	 ...
	 async function getData(){
		 ...
		 const stringTicket = returnTickerString();	
		 ...
		 const secondResponse = await fetch("http://localhost/my_projects/header/atomicwallet.github.io/js/assets.json",{
			 headers:{
				'Content-Type': 'application/json',
				'Accept': 'application/json'
			 }
		 ...
		 function returnTickerString() {return 'MOD,UKG,BRD,GTC,BKX,MDS,CND,ENG,DPY,C20,LEV,ATM,STORM,MOF,QSP,QASH,CS,DRGN,ETHOS,DCN,NOW,BTC,XRP,ETH,BCH,XLM,EOS,LTC,USDT,ADA,BSV,TRX,DASH,BNB,ETC,NEO,ONT,XTZ,ZEC,WAVES,BTG,VET,LSK,MKR,OMG,MGO,DOGE,ZRX,DCR,QTUM,AE,ZIL,BCD,DGB,NPXS,PMA,MITH,TUSD,GUSD,AWC,USDC,PPT,PAX,REP,GNT,HOT,IOST,WAX,MANA,WTC,NEXO,BNT,TPAY,BTT,DAI,VTHO,SMART,EURS,ABYSS,1ST,300,ADST,ADT,ADX,AIR,ALIS,ANT,VIDT,ARC,ARN,ART,ATH,ATL,AVT,BET,BLX,BMT,BNC,BQX,CAG,CAT,CCC,CDT,CFI,CMC,COB,CRB,CREDO,CVC,DATA,DENT,DICE,DNT,DRP,EDG,ELIX,EURT,FRD,FUEL,FUN,GNO,GUP,HGT,HST,ICE,ICN,ICOS,IFT,IND,IXT,JET,KICK,KIN,KNC,LATX,LIFE,LINK,LNC,LRC,LUN,MCAP,MCO,MNE,MSP,MTH,MTX,MYST,NET,NMR,OAX,OPT,PAY,PIX,PLAY,PLBT,PLR,PLU,POE,POS,PRO,PTOY,QAU,BAT,RLT,RLX,RVT,SALT,SCL,SENSE,SKIN,SNC,SNGLS,SNM,SNT,STX,SUB,SWT,TBT,TFL,TIME,TIX,TKN,TNT,TRST,VERI,VIBE,VIB,VIU,VRS,VSL,WINGS,XAUR,XID,XNN,BCPT,BIX,R,SRN,OCN,ELF,GVT,EVX,TNB,RUFF,AMB,THETA,POLY,APPC,JNT,NAS,DTA,SXUT,LEND,POWR,ITC,ENJ,RDN,MTN,REQ,WPR,DLT,GNX,AST,CMT,AIDOC,NULS';}
	 }
