...
<head>
    ...
    <meta name="description" content="Manage your Bitcoin, Ethereum, XRP, Litecoin, Stellar and over 300 tokens in Atomic secure wallet interface. Exchange and buy crypto for USD with credit card.">
    <link rel="stylesheet" href="css/main.css">
    <link rel="stylesheet" href="css/test-media.css">
    <!-- <link rel="stylesheet" href="css/aos.css"> -->
    <link rel="stylesheet" href="test/css/item-page-blog.css">

    <meta property="og:title" content="Atomic Wallet"/>
    <meta property="og:description" content="Manage your Bitcoin, Ethereum, XRP, Litecoin, Stellar and over 300 tokens in Atomic secure wallet interface. Exchange and buy crypto for USD with credit card."/>
...
<div class="only-mobile header-menu-mobile header-menu-close f-light" id="menu-mobile">
    <div class="container relative">
        ...
        <a href="<?php echo get_site_url(); ?>/support">Support</a>
...
<div class="container relative">
    ...
    <header class="header">
        ...
        <nav class="header-menu f-light">
            <a href="/" class="header-menu-here hvr-grow">Wallet</a>
            ...
            <a href="<?php echo get_site_url(); ?>/support" target="_blank" class="hvr-grow">Support</a>
            <a href="<?php echo get_site_url(); ?>/blog" class="hvr-grow">Blog</a>
        </nav>
...
<section class="reviews mobile-hide">
    <div class="container relative">
       ...
       <br> Rate us on <a href="https://www.trustpilot.com/review/atomicwallet.io"><img src="css/images/articles/trustpilot-logo.png" style="width: 10%;
    top: 15px;
    ...
    <div class="swiper-wrapper">
      <div class="swiper-slide"> 
                        ...
                        <div class="team-author hvr-grow">
                            <a href="https://twitter.com/CharlieShrem/status/1009538446678020104?s=09"><img src="css/images/team-3.jpg" class="team-author-avatar" alt>
                            <div class="team-author-name f-medium">Charlie Shrem</div>
                            
                                </a>
                        </div>
                        <div><img src="css/images/trustpilot.png" style="margin-bottom: 15px;" alt="">
                        </div>
    ...
    <div class="container relative">
        ...
        <div class="list-items f-medium">
            ...
            <a href="https://atomicwallet.io/tron">
             <div class="list-item hvr-float">
                <img src="css/images/crypto/TRX.svg" alt>
...
<div></div>
 <div class="swiper-container s4 swiper-container-horizontal only-mobile"> 
     <h3 class="features-title f-bold aos-init aos-animate only-mobile" data-aos="fade-right" data-aos-duration="800">Our Partners</h3> 
           <div class="swiper-wrapper">
      <div class="swiper-slide"><img src="css/images/partner-changelly.svg" width="70%" alt=""></div>
      <div class="swiper-slide"><img src="css/images/partner-ShapeShift.svg" width="70%" alt=""></div>
      <div class="swiper-slide"><img src="css/images/change-now.svg" width="70%" alt=""></div>
      <div class="swiper-slide"><a class="hvr-grow" href="https://www.blockchair.com/" target="_blank" rel="nofollow"><img src="css/images/partner-blockchair.png" alt=""></a></div>
       <div class="swiper-slide"><a class="hvr-grow" href="https://ethplorer.io/" target="_blank" rel="nofollow"><img src="css/images/partner-ethplorer.png" alt=""></a></div>
         <div class="swiper-slide"><img src="css/images/partner-coinmarketcap.png" alt=""></div>
          <div class="swiper-slide"><img src="css/images/partner-bbworldwide.png" alt=""></div>
...
<div class="partners mobile-hide">
    ...
    <div class="container relative cfx">
        <div class="partners-list">
            ...
            <img src="css/images/partner-changenow.png" alt=""></a>
                          ...
                          <li><a href="https://support.atomicwallet.io/">Support</a></li>
                           <li><a href="https://t.me/atomicwalletchat">Telegram chat</a></li>
                            ...
                            <li><a href="https://drive.google.com/drive/folders/1zbu1nKCBq2zNCnEtjWsw3oMJei6aFSuZ">Press Kit</a></li>
                                        ...
                                        <div class="footer-new-col">
                        <div class="footer-new-col-title">Buy Crypto?urrency</div>
                        <ul class="f-light">
